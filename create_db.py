...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'mcomerfo', 'email': 'mcomerfo@terpmail.umd.edu', 'first_name': 'Michael', 'last_name': 'Comerford',
            'password': generate_password_hash('mcomerfo', method='pbkdf2:sha256'), 'role': 'STUDENT'
        }
    ]
    ...
    students = [
        ...
        {'first_name': 'Michael', 'last_name': 'Comerford', 'email': 'mcomerfo@terpmail.umd.edu',
            'major_id': 3, 'birth_date': dt.strptime('2004-10-23', '%Y-%m-%d'),'is_honors': 0
        }
    ]
